      ...
      return (
            <>
                  <button
                        ...
                        className="fixed bottom-6 right-6 z-[45] bg-anyflow-lime text-black font-mono text-[10px] md:text-xs px-3 py-2 border border-slate-800 hover:bg-white transition-colors flex items-center gap-2 shadow-[2px_2px_0px_0px_rgba(255,255,255,0.1)] rounded-none"
                        ...
                        <div className="w-full max-w-lg bg-slate-900 border border-slate-800 rounded-xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                              <div className="flex items-center border-b border-slate-800 px-3">
                                    ...
                                    <Command.Input
                                          ...
                                          className="flex h-12 w-full rounded-md bg-transparent py-3 text-sm outline-none placeholder:text-slate-400 disabled:cursor-not-allowed disabled:opacity-50 text-slate-100 font-mono"
                                    />
                                    <div className="flex items-center gap-1 text-[10px] font-mono text-slate-400 bg-slate-950 px-2 py-1 rounded border border-slate-800">
                              ...
                              <Command.List className="max-h-[300px] overflow-y-auto p-2 scrollbar-hide">
                                    ...
                                    <Command.Group heading={t.commands.nav_group} className="px-2 text-xs font-mono text-slate-400 mb-2">
                                          <Command.Item
                                    ...
                                    <Command.Group heading={t.commands.system_group} className="px-2 text-xs font-mono text-slate-400 mb-2 mt-2">
                                          <Command.Item
